...
CREATE SEQUENCE ORDER_ID_SEQ NOCACHE; --주문코드를 위한 시퀀스
...
create table order_line(
  ...
  unit_price number(12) not null, --단가 //상품에 단가일수도 있고 쿠폰을 포함한 총단가일 수도 있음
...
CREATE SEQUENCE ORDER_LINE_ID_SEQ  NOCACHE; --주문상세코드를 위한 시퀀스
